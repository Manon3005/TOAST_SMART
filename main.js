...
ipcMain.handle('dialog:openFile', async () => {
  ...
  if (result.canceled) {
    ...
    return ParserService.getColumnNamesFromCsvFile(ParserService.getColumnNamesFromCsvFile(ParserService.getColumnNamesFromCsvFile(ParserService.getColumnNamesFromCsvFile(ParserService.getColumnNamesFromCsvFile(filePath)))));
  }
});
