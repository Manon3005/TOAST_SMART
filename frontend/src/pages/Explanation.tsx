    ...
    <div className="flex flex-col gap-[50px] my-[20px]">
      ...
      <div className="flex flex-col items-center justify-center gap-[50px]">
        <ExplainText>
          ...
          <ul className="list-disc ml-8 py-[10px]">
            ...
            <li>
              Champ mentionnant les personnes avec qui le participant veut
              manger
            </li>
          </ul>
          <Paragraph>
        ...
        <ExplainText>
          ...
          <Paragraph>
            ...
            sous forme d'un .csv contenant une ligne par diplômé et le placement
            associé. Chaque table est identifiée par un numéro. Par la même
            occasion, nous générons un fichier .csv dans lequel nous suggérons
            des regroupements de tables à placer à proximité afin de rapprocher
            des invités qui souhaitent manger à la même table mais que nous
            n'avons pas pu satisfaire.
          </Paragraph>
          <Paragraph>
